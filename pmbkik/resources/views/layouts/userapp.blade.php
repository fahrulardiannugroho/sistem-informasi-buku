				...
				<div class="row py-4">
					<div class="col-12 col-md-6">
						<div class="cta-text">
								...
								<p class="text-secondary">Kelurahan Bungkutoko, Kec. Abeli, <br> Kota Kendari</p>
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="cta-text">
								<h4 class="text-right"><i class="fas fa-phone"></i> Kontak</h4>
								<p class="text-right text-secondary">082396560191 <br> a.n x</p>
						</div>
					</div>
				</div>
			</div>
